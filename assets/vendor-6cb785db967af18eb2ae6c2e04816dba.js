...
return e.replace(L,F)},e.htmlSafe=U,e.isHTMLSafe=B,e._resetRenderers=function(){Yt.length=0},e.renderSettled=function(){null===Jt&&(Jt=A.default.defer(),(0,f.getCurrentRunLoop)()||f.backburner.schedule("actions",null,Qt))
...
class Nt{constructor(e){this.resolvedName=e,this.handle=-1,this.manager=Mt,this.compilable=null,this.capabilities=(0,d.capabilityFlagsFrom)(At),this.state={name:e}}}var It,jt,Dt,Lt=X(((e,t)=>{var r,n,i,a=e.positional[0]
...
var Bt={action:te,mut:Et,readonly:Ot,unbound:Rt,"query-params":wt,"-hash":g.hash,"-each-in":ot,"-normalize-class":yt,"-track-array":_t,"-mount":Lt,"-outlet":Ft,"-in-el-null":bt},Vt=(0,t.assign)((0,t.assign)({},Bt),{array:g.array,concat:g.concat,fn:g.fn,get:g.get,hash:g.hash}),$t={action:xt},zt=(0,t.assign)((0,t.assign)({},$t),{on:g.on})
new m._WeakSet
...
null!==a&&(a.isInitializing()||a.isPrototypeMeta(e))||(j(e,r),L<=0&&A(),D in e&&(4===arguments.length?e[D](r,i):e[D](r)))}function U(){L++,C=!0}function B(){--L<=0&&(A(),function(){for(var[e,t,r]of(C=!1,P))S(e,t,r)
P=[]}())}function V(e){U()
...
O(e,R[C]),f.push(P)}}e(82,w,t.EMPTY_STRING_ARRAY,E),f.push(-1)}else if(null!==l)for(var S=l[0],k=l[1],x=0;x<k.length;x++){var A=S[x],M=d.indexOf(A);-1!==M&&(O(e,k[x]),f.push(M),m.push(A))}e(97,r.$s0),(0,i.hasCapability)(n,64)&&e(59);(0,i.hasCapability)(n,512)&&e(87,0|u.has("default"),r.$s0)
...
return 2===arguments.length?(t=arguments[0],i=arguments[1],e=null):([e,t,n]=g(...arguments),void 0===n?i=0:s(i=n.pop())||(r=!0===i,i=n.pop())),[e,t,n,i=parseInt(i,10),r]}var y=0,_=0,E=0,w=0,O=0,R=0,T=0,C=0,P=0,S=0,k=0,x=0,A=0,M=0,N=0,I=0,j=0,D=0,L=0,F=0,U=0
...
this._platform=r(this._boundAutorunEnd)}get counters(){return{begin:_,end:E,events:{begin:w,end:0},autoruns:{created:D,completed:L},run:O,join:R,defer:T,schedule:C,scheduleIterable:P,deferOnce:S,scheduleOnce:k,setTimeout:x,later:A,throttle:M,debounce:N,cancelTimers:I,cancel:j,loops:{total:F,nested:U}}}get defaultQueue(){return this._defaultQueue}begin(){_++
...
for(var ge in a("instrument",!0),ve)ve.hasOwnProperty(ge)&&fe(ge,ve[ge])}var be={asap:J,cast:he,Promise:R,EventTarget:n,all:A,allSettled:N,race:I,hash:D,hashSettled:F,rethrow:U,defer:B,denodeify:S,configure:a,on:fe,off:me,resolve:z,reject:H,map:$,async:pe,filter:Y}
